...
(function () {
  ...
  function renderMethod() {
    ...
    const rows = [
      ...
      ['Effet de trésorerie de la suppression la première année', `environ ${fmt(P.abatt.effetTresorerie, 2)} fois le rendement annuel, soit 7,6 à 7,8 Md€ [à confirmer]`, src('pas') + ' ; ' + src('nezzar')],
      ...
      ['Coût de l\'ensemble des taux réduits de CSG (0, 3,8 et 6,6 %)', `de l'ordre de ${P.csg.coutTauxReduits} Md€ par an [estimation]`, src('cfdt') + ' ; ' + src('nezzar')],
    ...
    $('#method-content').innerHTML = `
      ...
      <details><summary>Comment sont calculées les économies</summary>
        <ul>
          ...
          <li><strong>Première année :</strong> si la suppression s'applique dès les revenus 2026, l'État encaisse en 2027 le solde de l'impôt 2026 sans abattement et, à partir de septembre, un prélèvement à la source relevé sur les revenus 2027 : environ un tiers d'année en plus, soit 7,6 à 7,8 Md€ la première année pour une suppression totale selon l'économiste Rayan Nezzar (citation provisoire, en attendant le document source). C'est un effet de trésorerie, non reconduit ; la jauge affiche le rendement durable.</li>
